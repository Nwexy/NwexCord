...
class LiveStreamManager:
    ...
    def _run_flask():
        ...
        def index():
            ...
            audio_btn_text = "Disable Audio" if LiveStreamManager._audio_enabled else "Enable Audio"
        ...
        def config():
            ...
            if 'toggle_audio' in data: LiveStreamManager._audio_enabled = not LiveStreamManager._audio_enabled
